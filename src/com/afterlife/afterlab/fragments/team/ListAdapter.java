...
public class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public FrameLayout mTeamBase;
        public LinearLayout mLayoutKanan;
        ...
        public ViewHolder(View itemView) {
            ...
            mTelegram = itemView.findViewById(R.id.devTelegram);
            mTelegramName = itemView.findViewById(R.id.telegramName);
            mTeamBase = itemView.findViewById(R.id.team_base);
            mLayoutKanan = itemView.findViewById(R.id.layout_kanan);

            mContext = itemView.getContext();
            mTeamBase.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mLayoutKanan.getVisibility() == View.GONE) {
                            mLayoutKanan.setVisibility(View.VISIBLE);
                        } else {
                            mLayoutKanan.setVisibility(View.GONE);
                        }
